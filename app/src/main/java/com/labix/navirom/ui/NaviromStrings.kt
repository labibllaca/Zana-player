...
object NaviromStrings {
    ...
    private val englishStrings = mapOf(
        ...
        "settings_dual_audio" to "Dual Audio Mode (Play 2 Tracks Simultaneously)",
        "settings_dual_audio_desc" to "Replaces lyric preview with a 2nd player deck in the full player. Long press any track in song lists to pick Player 1 or Player 2.",
        "dual_audio_player_1" to "Player 1 (Main)",
        "dual_audio_player_2" to "Player 2 (Secondary)",
        "dual_audio_deck_title" to "Player 2 (Deck B)",
        "dual_audio_deck_empty" to "Player 2 is idle. Long press a song to play here.",
        "dual_audio_deck_stop" to "Stop & Eject Deck 2",
        "sync_decks_title" to "Sync Decks (Mirror Playback)",
        "sync_decks_desc" to "Play the same track on both players in sync. Route Deck 1 and Deck 2 to separate Bluetooth speakers/devices.",
        "sync_decks_active" to "Decks Synced",
        "sync_decks_enable" to "Sync Decks",
        "sync_decks_disable" to "Unsync Decks",
        "audio_routing_title" to "Audio Output Routing",
        "audio_routing_desc" to "Route Player 1 and Player 2 to different Bluetooth devices or speaker outputs.",
        "audio_routing_deck1" to "Player 1 (Deck A) Output",
        "audio_routing_deck2" to "Player 2 (Deck B) Output",
        "audio_routing_default" to "Default System Audio",
        "audio_routing_no_devices" to "No external audio devices connected",
        "audio_routing_bt_hint" to "Connect Bluetooth speakers or headphones in Android Settings to route decks independently.",
        "dialog_select_player_title" to "Select Player",
        "dialog_select_player_desc" to "Choose which player to start playback on:",
    ...
    private val albanianStrings = mapOf(
        ...
        "settings_dual_audio" to "Modaliteti me Dy Audio (Luaj 2 Këngë Njëkohësisht)",
        "settings_dual_audio_desc" to "Zëvendëson tekstin 1-rresht me një luajtës të dytë të pavarur. Shtyp gjatë çdo këngë për ta zgjedhur te Luajtësi 1 ose 2.",
        "dual_audio_player_1" to "Luajtësi 1 (Kryesori)",
        "dual_audio_player_2" to "Luajtësi 2 (Dytësor)",
        "dual_audio_deck_title" to "Luajtësi 2 (Deck B)",
        "dual_audio_deck_empty" to "Luajtësi 2 është bosh. Shtyp gjatë një këngë për ta luajtur këtu.",
        "dual_audio_deck_stop" to "Ndalo & Hiq Luajtësin 2",
        "sync_decks_title" to "Sinkronizo Luajtësit (Pasqyro Muzikën)",
        "sync_decks_desc" to "Luaj të njëjtën këngë në të dy luajtësit njëkohësisht. Zgjidh pajisje të ndryshme Bluetooth për Luajtësin 1 dhe 2.",
        "sync_decks_active" to "Luajtësit të Sinkronizuar",
        "sync_decks_enable" to "Sinkronizo Luajtësit",
        "sync_decks_disable" to "Çsinkronizo Luajtësit",
        "audio_routing_title" to "Drejtimi i Daljes Audio",
        "audio_routing_desc" to "Dërgo Luajtësin 1 dhe Luajtësin 2 në pajisje të ndryshme Bluetooth ose altoparlantë.",
        "audio_routing_deck1" to "Dalja e Luajtësit 1 (Kuvertë A)",
        "audio_routing_deck2" to "Dalja e Luajtësit 2 (Kuvertë B)",
        "audio_routing_default" to "Audio e Parazgjedhur e Sistemit",
        "audio_routing_no_devices" to "Nuk ka pajisje të jashtme audio të lidhura",
        "audio_routing_bt_hint" to "Lidhni altoparlantë ose kufje Bluetooth te Cilësimet e Android për t'i drejtuar veçmas.",
        "dialog_select_player_title" to "Zgjidh Luajtësin",
        "dialog_select_player_desc" to "Zgjidh në cilin luajtës dëshiron ta luash këtë këngë:",
    ...
    private val germanStrings = mapOf(
        ...
        "perm_btn_grant" to "Erlauben",
        "perm_btn_continue" to "Weiter",
        "perm_btn_skip" to "Überspringen",
        ...
        "settings_dual_audio" to "Dual-Audio-Modus (2 Titel gleichzeitig abspielen)",
        "settings_dual_audio_desc" to "Ersetzt die Songtext-Vorschau durch ein 2. Player-Deck im Vollbildplayer. Halte einen Titel gedrückt, um Spieler 1 oder 2 zu wählen.",
        "dual_audio_player_1" to "Spieler 1 (Haupt)",
        "dual_audio_player_2" to "Spieler 2 (Sekundär)",
        "dual_audio_deck_title" to "Spieler 2 (Deck B)",
        "dual_audio_deck_empty" to "Spieler 2 ist inaktiv. Halte einen Titel gedrückt, um ihn hier abzuspielen.",
        "dual_audio_deck_stop" to "Deck 2 stoppen & auswerfen",
        "sync_decks_title" to "Decks synchronisieren (Spiegel-Wiedergabe)",
        "sync_decks_desc" to "Gleichen Titel auf beiden Decks synchron abspielen. Deck 1 und Deck 2 auf verschiedene Bluetooth-Geräte leiten.",
        "sync_decks_active" to "Decks synchronisiert",
        "sync_decks_enable" to "Decks synchronisieren",
        "sync_decks_disable" to "Synchronisierung aufheben",
        "audio_routing_title" to "Audio-Ausgabe-Routing",
        "audio_routing_desc" to "Player 1 und Player 2 auf verschiedene Bluetooth-Geräte oder Lautsprecher leiten.",
        "audio_routing_deck1" to "Player 1 (Deck A) Ausgabe",
        "audio_routing_deck2" to "Player 2 (Deck B) Ausgabe",
        "audio_routing_default" to "Standard-Systemaudio",
        "audio_routing_no_devices" to "Keine externen Audiogeräte verbunden",
        "audio_routing_bt_hint" to "Verbinde Bluetooth-Lautsprecher oder Kopfhörer in den Android-Einstellungen für getrenntes Routing.",
        "dialog_select_player_title" to "Spieler wählen",
        "dialog_select_player_desc" to "Wähle aus, auf welchem Spieler die Wiedergabe starten soll:",
