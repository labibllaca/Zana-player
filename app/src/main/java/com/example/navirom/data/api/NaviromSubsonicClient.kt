...
import com.example.navirom.data.api.dto.SubsonicRootResponse
...
class NaviromSubsonicClient(
    ...
    suspend fun getMusicFolders(): Result<List<com.example.navirom.data.api.dto.MusicFolderDto>> {
    ...
    private fun parseSearchResult(result: com.example.navirom.data.api.dto.SearchResult3Dto?): Triple<List<NaviromArtist>, List<NaviromAlbum>, List<NaviromTrack>> {
